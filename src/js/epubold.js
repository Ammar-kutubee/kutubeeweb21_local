  ...
  display(section, target) {
    ...
    if (visible && section && this.layout.name !== "pre-paginated") {
      ...
      if (this.settings.direction === "ltr") {
        ...
        this.scrollTo((offset.left + width) - this.layout.pageWidth, offset.top, true);
      }

      if (target) {
        console.warn('section11111111',section);
        console.warn('visible1111',visible);
        // console.warn('view111111',view);
        console.warn('target11111',target);
    ...
    this.add(section, forceRight).then(function (view) {
      ...
      if (target) {
        ...
        if (this.settings.direction === "ltr") {
          ...
          console.warn('ttttttttttttttttttop',offset);
          this.moveTo(0);
        }
      }
    }.bind(this), err => {
  ...
  next(n) {
    ...
    if (this.isPaginated && this.settings.axis === "horizontal" && (!dir || dir === "ltr")) {
      ...
      if (this.settings.rtlScrollType === "default") {
        ...
        console.log('sssssssssssssssss next',left)
        if (left > 0) {
          this.scrollBy(this.layout.delta * n, 0, true);
        } else {
          next = this.views.last().section.next();
        ...
        left = Math.floor(this.container.scrollLeft);
        console.log('sssssssssssssssss next 2',left)
  ...
  located(location) {
    ...
    let located = {
      start: {
        ...
        displayed: {
          page: start.totalPages - start.pages[0] || 1,
...
class continuous_ContinuousViewManager extends managers_default["a" /* default */] {
  ...
  check(_offsetLeft, _offsetTop) {
    ...
    if (newViews.length) {
      console.log('nnnnnnnnnnnnn',newViews)
  ...
  next() {
    ...
    console.log('ssssssssssssssssss3',this.layout.props.name,delta)
    if (!this.views.length) return;
