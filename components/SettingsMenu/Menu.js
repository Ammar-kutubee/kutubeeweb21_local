		...
		<div>
			<Menu vertical>
				<div className='flex-wrapper-col menu-item'>
					<Menu.Item className='section-title' name={t('settings.password')} active={activeItem === 'password'} onClick={handleItemClick}>
				...
				<div className='flex-wrapper-col menu-item'>
					<Link href='https://www.kutubee.com/' passHref={true}>
						<Menu.Item className='section-title' name={t('settings.contact')} active={activeItem === 'contact'}>
							<Label className='grey-menu-text icon-right-arrow'></Label>
							{t('settings.contact')}
						</Menu.Item>
					</Link>
