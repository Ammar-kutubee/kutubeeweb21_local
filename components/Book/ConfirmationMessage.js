...
export default function ConfirmationMessage({ userId, confirmationMessage, confirmationType, type, setOpen, open, onConfirmationYes, currentLanguage }) {
            ...
            <Modal.Content>
                ...
                <div className="flex-wrapper-col flex-center align-center">
                    ...
                    <div style={{ width: '55%', marginTop: '25px' }} >
                        ...
                        <CustomButton
                            text={confirmationType.includes('delete') ? t("bookComponent.yesDelete",{lng:currentLanguage}) : t("bookComponent.yesShare",{lng:currentLanguage})}
                    ...
                    <div className="whitebtn" style={{ width: '55%', marginTop: '25px' }} >
                        ...
                        <CustomButton onPress={() => setOpen(false)}
                            text={t("bookComponent.cancel",{lng:currentLanguage})}
